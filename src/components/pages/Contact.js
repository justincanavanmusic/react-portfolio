        ...
        <div className="row">
          <div className="mx-auto col-sm-12 col-md-9 col-lg-6">
            ...
            <div className="d-flex justify-content-center">
              <div className="card mb-5 list-items contact-card col-9 col-sm-9 col-md-10 col-lg-10">
                {messageForm.map((oneForm) => (
                  <div>
                    ...
                    <div className="message-input col-10 col-sm-10 col-lg-10 col-md-10">
                      <input
                        type="text"
                        name={oneForm.name}
                ...
                <div>
                  ...
                  <div className="message-input col-10 col-lg-10 col-md-10 col-sm-10">
                    <textarea
          ...
          <div className="margin-auto col-12 col-sm-12 col-md-9 col-lg-6">
            ...
            <div className="card contact-card col-lg-10 col-md-10 col-sm-9 col-9">
